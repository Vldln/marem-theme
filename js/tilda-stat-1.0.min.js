!(function () {
  ...
  function u() {
    if (!("" < g.user_agent && -1 != g.user_agent.indexOf("bot")))
      if ("http:" != window.location.protocol && "https:" != window.location.protocol) console.log("TildaStat: cannot work on local page");
        ...
        var n = !1;
        if ((/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && (n = !0), (g.ismobile = n), document.getElementById("tildastatscript") && (g.tildastatcode = document.getElementById("tildastatscript").key), h))
          try {
            var e = function (e) {
                m = !!e;
              },
  ...
  function p() {
    f || ((n("tildasid") || "") != g.sessionid && o("tildasid", g.sessionid, { expires: 1800, path: "/" })), "" === g.referrer && (g.referrer = n("previousUrl") || ""), (g.tildautm = n("TILDAUTM") || ""), g.page || (console.log("TildaStat: page empty"), (g.page = d()), window.location.hash && 0 === window.location.hash.indexOf("#!") && (g.page += window.location.hash)), "/" === g.page.substring(0, 1) && (g.page = window.location.hostname + g.page);
    var e = (function (e) {
        var t,
          n = "";
        for (t in e)
    ...
    t.open("POST", "https://stat.tildacdn.com/event/", !0),
      ...
      (t.timeout = 3e3),
      t.send(e),
      g.page && -1 === g.page.indexOf("tilda/scroll") && -1 === g.page.indexOf("tilda/readtime") && -1 === g.page.indexOf("tilda/click") && -1 === g.page.indexOf("tilda/cookieenabled") && ((g.referrer = g.page), f || o("previousUrl", g.page, { path: "/", expires: 1800 })),
      (g.page = ""),
