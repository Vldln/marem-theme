...
function t_menu__slideElement(e, t, n) {
  var r = "toTop" === n ? 0 : t,
    ...
    o = setInterval(function () {
      (e.style.transform = "translateY(-" + r + "px)"), (e.style.opacity = i.toString()), (i = "toTop" === n ? i - 0.1 : i + 0.1), (r = "toTop" === n ? r + t / 20 : r - t / 20), "toTop" === n && r >= t && ((e.style.transform = "translateY(-" + t + "px)"), (e.style.opacity = "0"), clearInterval(o)), "toBottom" === n && r <= 0 && ((e.style.transform = "translateY(0px)"), (e.style.opacity = "1"), clearInterval(o));
    }, 10);
}
