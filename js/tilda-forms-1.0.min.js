(window.t_forms__lang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2)),
    ...
    if (a || n || s) {
      ...
      if (!document.head.querySelector('script[src*="' + l + '"]'))
        ((c = document.createElement("script")).type = "text/javascript"),
          (c.src = "https://static.tildacdn.com/js/" + l + ".min.js"),
          (c.onerror = function () {
  ...
  (window.tildaForm.validate = function (t) {
        ...
        if (d && (E || (A && x))) w.type.push("req");
          ...
          switch (u) {
            ...
            case "number":
              ...
              break;
            case "date":
              var k = { "DD-MM-YYYY": /^(0[1-9]|1[0-9]|2[0-9]|3[01])[\-\.\/](0[1-9]|1[012])[\-\.\/][0-9]{4}$/, "MM-DD-YYYY": /^(0[1-9]|1[012])[\-\.\/](0[1-9]|1[0-9]|2[0-9]|3[01])[\-\.\/][0-9]{4}$/, "YYYY-MM-DD": /^[0-9]{4}[\-\.\/](0[1-9]|1[012])[\-\.\/](0[1-9]|1[0-9]|2[0-9]|3[01])$/ };
    ...
    if ("y" === b) {
      var T = void 0 !== window.tcart_minorder && window.tcart_minorder > 0,
        ...
        w,
        w;
      if (T) if (window.tcart.prodamount < window.tcart_minorder) (w = { obj: {}, type: [] }).type.push("minorder"), o.push(w);
      if (C && window.tcart.total < window.tcart_mincntorder) (w = { obj: {}, type: [] }).type.push("minquantity"), o.push(w);
    }
  ...
  (window.tildaForm.showErrorInPopup = function (t, r) {
    ...
    p ||
      ...
      t_addEventListener((p = document.getElementById("tilda-popup-for-error")), "click", function (t) {
        var r, o;
      ...
      if (r[f] && r[f].obj) {
        ...
        for (var w = 0; w < r[f].type.length; w++) {
          var y = r[f].type[w],
            h = t_forms__getMsg(y);
          (u = ""),
            (c = t.querySelector(".js-rule-error-" + y)) ? ((c.textContent && c.innerText) || !h || -1 !== m.indexOf(h) ? ((u = c.textContent || c.innerText), -1 === m.indexOf(u) && (m = m + '<p class="t-form__errorbox-item">' + u + "</p>")) : (m = m + '<p class="t-form__errorbox-item">' + h + "</p>")) : h && -1 === m.indexOf(h) && (m = m + '<p class="t-form__errorbox-item">' + h + "</p>"),
            s &&
              (!u && t_forms__getMsg(y + "field") ? (u = t_forms__getMsg(y + "field")) : h && (u = h),
              u &&
                n &&
    ...
    for (var a = "", n = !1, s = !0, l = "", c = "", d = "", u = [], m = 0; m < r.length; m++)
      if (r[m] && r[m].obj) {
        ...
        for (var p = 0; p < r[m].type.length; p++) {
          ...
          n &&
            (!d && t_forms__getMsg(y + "field") ? (d = t_forms__getMsg(y + "field")) : !d && t_forms__getMsg(y) && (d = t_forms__getMsg(y)),
            d &&
              a &&
                ...
                if ("object" == typeof objData) {
                  ...
                  if (objData && objData.error) {
                    ...
                    if (window.Tilda && "function" == typeof window.Tilda.sendEventToStatistics) {
                      ...
                      try {
                        ga && "tilda" !== window.mainTracker && ga("send", { hitType: "pageview", page: dataEventName, title }), window.mainMetrika && window[window.mainMetrika] && window[window.mainMetrika].hit(dataEventName, { title, referer: window.location.href });
                      } catch (error) {
...
function t_forms__combineFieldsWithDefWidth(t, r) {
  ...
  t_forms__createArrWithAllRows(t, "t-input-group_widthdef").forEach(function (t) {
    ...
    o.forEach(function (t) {
      var o,
        a = "t-input-group_width" + ({ 4: "25", 3: "33", 2: "50" }[t.length] || "100");
      t.forEach(function (t) {
...
function t_forms__calculateFieldsWidthInJS(t, r) {
  var o = 15,
    a = { 1: "t-input-block_width100", 2: "t-input-block_width50", 3: "t-input-block_width33", 4: "t-input-block_width25" };
  for (var n in a)
  ...
  if (o) {
    ...
    if (a) {
      ...
      if ((o.tildaSendingStatus && (l = o.tildaSendingStatus), !((l && l >= 1) || t_hasClass(o, "t706__submit_disable")))) {
        ...
        var c,
          d = document.getElementById("allrecords").getAttribute("data-tilda-formskey"),
        ...
        if (!a.querySelectorAll(".js-formaction-services").length && 1 !== u && !d) {
          ...
          return (
            ...
            void t_triggerEvent(a, "tildaform:aftererror")
          );
        }
        if (a.querySelector(".g-recaptcha") && grecaptcha) {
          ...
          if (w) grecaptcha.reset(w);
            ...
            var y = { size: "invisible", sitekey: a.getAttribute("data-tilda-captchakey"), callback: window.tildaForm.captchaCallback };
...
function t_forms__getErrorContainers(t, r) {
  ...
  return (
    o.length || (t.insertAdjacentHTML("afterbegin", '<div class="js-errorbox-all"></div>'), (o = t.querySelectorAll(".js-errorbox-all"))),
    a.length ||
      (Array.prototype.forEach.call(o, function (t) {
...
function t_serializeArray(t) {
  for (var r = [], o = t.querySelectorAll("input, textarea, button, select"), a = 0; a < o.length; a++) {
    ...
    if (!(!o[a].name || o[a].disabled || ["file", "reset", "submit", "button"].indexOf(o[a].type) > -1 || (n && n.getAttribute("data-hidden-by-condition"))))
      if ("select-multiple" !== o[a].type) (["checkbox", "radio"].indexOf(o[a].type) > -1 && !o[a].checked) || r.push({ name: o[a].name, value: o[a].value });
      else for (var s = o[a].options, l = 0; l < s.length; l++) s[l].selected && r.push({ name: s[l].name, value: s[l].value });
  }
  return r;
}
  ...
  if ("none" !== t.style.display)
    var r = 1,
      o = setInterval(function () {
        (t.style.opacity = r), (r -= 0.1) <= 0.1 && (clearInterval(o), (t.style.display = "none"), (t.style.opacity = null));
      }, 30);
}
function t_fadeIn(t) {
