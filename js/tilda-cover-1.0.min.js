...
function cover_init(e) {
  ...
  if (r) {
    var i,
      c = { "cover-bg": "", "cover-height": "", "cover-parallax": "", "video-url-mp4": "", "video-url-webm": "", "video-url-youtube": "", "video-noloop": "", "video-nomute": "", "video-nocover": "", "bg-base64": "" };
    for (i in c) {
      var a = r.getAttribute("data-content-" + i);
      a && (c[i] = a);
    }
    (o = o ? o.getAttribute("data-bg-color") : ""),
      (o = (o && (c["parent-bg"] = o), ["mp4", "webm", "youtube"])),
      (o =
        ("yes" === c["video-nocover"]
...
function t_cover__setCoverParams(e, t, o) {
  ...
  t["parent-bg"] && (r = e.closest(".t-cover")) && r.classList.add("t-cover__transparent"),
    ...
    a && !window.t_cover__isMobile && ((r = t_cover__getPureHeight(e)) < window.innerHeight && ((c = 0.2 * window.innerHeight), (e.style.height = r + c + "px")), t_cover__parallax(e)),
    d &&
      t["cover-bg"] &&
      !o &&
      ((n = !1),
...
function t_cover__createAndProcessHTML5Video(e, t, o, r) {
  t_onFuncLoad("t_videoprocessor__processHTML5Video", function () {
    t_videoprocessor__processHTML5Video(e, { mp4: t["video-url-mp4"], ogv: "", webm: t["video-url-webm"], poster: "", autoplay: !0, loop: o, scale: !0, position: "absolute", opacity: 1, textReplacement: !1, zIndex: 0, width: "100%", height: 0, volume: 1, muted: r, fullscreen: !1, imgFallback: !0 });
  });
}
function t_cover__recalcCoverHeight(e, t) {
  ...
  _ &&
    ...
    e &&
      "935" !== a &&
      ((l = (o = _.querySelector(".t-cover__carrier")) ? o.getAttribute("data-content-cover-height") : "") || (l = (r = _.querySelector("[data-content-cover-height]")) ? r.getAttribute("data-content-cover-height") : ""),
      ...
      (c = t_cover__getHeightFromAttr(l)) &&
        n.forEach(function (e) {
          (i && ".t-cover__carrier" === e) ||
            Array.prototype.slice.call(_.querySelectorAll(e)).forEach(function (e) {
      ...
      (a = a || l),
      r || ((d = e.style.height), (e.style.height = ""), (a = l), d && (e.style.height = d)),
      (l = t_cover__getContentHeight(_)),
      (e = !!o && "100vh" === o.getAttribute("data-content-cover-height")),
      (300 < l && a < l + 40) || r || ((window.t_cover__isMobile || "ontouchend" in document) && t)
        ? (t_cover__setRecalculatedHeight(_, l), t_cover__updateResizeElem(_))
...
function t_cover__setRecalculatedHeight(t, e) {
  var o = t.querySelector(".t-cover__carrier"),
    ...
    a =
      ((r || t.querySelector(".t734")) && c.push(".t-slds__items-wrapper"),
      c.forEach(function (e) {
        Array.prototype.slice.call(t.querySelectorAll(e)).forEach(function (e) {
          i && e && e.classList.contains("t-cover__carrier") && d < document.documentElement.clientHeight ? ((l = 0.2 * document.documentElement.clientHeight), (e.style.height = d + l + "px")) : e && (e.style.height = d + "px");
        });
      }),
